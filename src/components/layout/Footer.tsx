        ...
        <footer className="bg-[#000000] border-t border-white/10 text-white pt-24 pb-12 px-6 md:px-12">
            ...
            <div className="max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 text-sm mb-24">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <Link href="#" className="text-gray-400 hover:text-white transition-colors">Business Overview</Link>
                    <Link href="#" className="text-gray-400 hover:text-white transition-colors">API Platform</Link>
                    <Link href="#" className="text-gray-400 hover:text-white transition-colors">Contact Sales</Link>
                </div>
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <Link href="/support" target='_blank' className="text-gray-400 hover:text-white transition-colors">Help Center</Link>
            ...
            <div className="max-w-[1400px] mx-auto pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500 font-medium">
                    {/* FIXED: Wrapped Image in relative div with fill prop to avoid dimension warnings */}
